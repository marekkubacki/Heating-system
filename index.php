...
<head>
	...
	<script src="https://js.hcaptcha.com/1/api.js" async defer></script>  <!captcha ES_4b30aa1a8e7a46d49********* > 
...
<body>
    ...
    <form method="post" action="" class="animacja-wlaczania">
        ...
        <input type="password" maxlength="10" name="pin" id="pin">
		...
		<?php
			...
			if($proby['i']>4)
			{
				echo("<div class='h-captcha' data-sitekey='************'></div>");
			}
